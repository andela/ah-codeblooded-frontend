...
import { ARTICLE_FETCH, ARTICLE_PUBLISH, ARTICLE_SAVE } from './types';
...
describe('Article actions', () => {
  ...
  it('fetches an article by slug and dispatches ARTICLE_FETCH_SUCCESS', () => {
    axiosMock.onGet(getURL(`articles/${article.slug}/`)).reply(200, { data: article });
  ...
  it('saves an article by slug and dispatches ARTICLE_SAVE_SUCCESS', () => {
    axiosMock.onPost(getURL('articles/')).reply(201, { data: { ...article, slug: null } });
  ...
  it('publishes an article', () => {
    axiosMock
      .onPut(getURL(`articles/${article.slug}/`))
  ...
  it('fails to get an article', () => {
    axiosMock.onGet(getURL(`articles/${article.slug}/`)).reply(400, { data: article });
